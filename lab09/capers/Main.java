...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        // FIXME
        File story = Utils.join(CAPERS_FOLDER, "story");
        String saved = Utils.readContentsAsString(story);
        Utils.writeContents(story, saved + args[1] + "\r");
        saved = Utils.readContentsAsString(story);
    ...
    public static void makeDog(String[] args) throws IOException {
        ...
        File dog = new File(capers.Dog.DOG_FOLDER, args[1]);
        dog.createNewFile();
        capers.Dog dog1 = new capers.Dog(args[1], args[2], Integer.parseInt(args[3]));
        dog1.saveDog();
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        capers.Dog dog = capers.Dog.fromFile(args[1]);
        dog.haveBirthday();
        dog.saveDog();
    }
